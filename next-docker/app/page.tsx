            ...
            allTasks.map((task) => (
              ...
              >
                <div className="flex flex-col space-y-1.5 p-6">
                  <h3 className="text-black font-semibold leading-none tracking-tight">
                    {task.title}
                  </h3>
                ...
                <div className="items-center flex justify-end px-6 pb-6">
                  <span className="inline-block bg-green-200 rounded-full px-3 py-1 text-sm font-semibold text-green-950">
                    {task.status}
                  </span>
                </div>
              </div>
